...
import './Profile.css'
import logo from '../assests/drivinglicence.jpeg'
        ...
        <div className="form">
            ...
            <Form className="ms-4">
                <Form.Group as={Row} className="my-3" controlId="formHorizontalEmail">
                    ...
                    <Col sm={3}>
                    <Form.Control type="email" placeholder="Email" value={email} onChange={emailChange} />
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="my-3" controlId="formHorizontalPassword">
                    ...
                    <Col sm={3}>
                    <Form.Control type="text" placeholder="Username" value={username} onChange={usernameChange} />
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="my-3" controlId="formHorizontalPassword">
                    ...
                    <Col sm={3}>
                    <Form.Control type="number" placeholder="Phone Number" value={phnumber} onChange={phnumberChange} />
                    </Col>
                </Form.Group>
                
                <div>
                <Form.Label column sm={2} className="my-1 mr-2" htmlFor="inlineFormCustomSelectPref">
                    Driving Licence
                </Form.Label>
