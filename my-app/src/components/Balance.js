        ...
        <div>
            ...
            <div class="card w-75 container my-5">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary" onClick={()=>setbuttonpopup(true)}>Add Money</a>
                </div>
                <BalancePopup trigger={buttonpopup}>
                    <h1>Add money</h1>
                    <input type="number" value={addmoney} onChange={addMoney}/>
                    <div className="my-3">
                    <button type="button" className="btn btn-success" onClick={addedMoney}>Add</button>
                    <button type="button" class="btn btn-danger mx-2" onClick={()=>setbuttonpopup(false)}>Cancel</button>
                    </div>
                </BalancePopup>
            </div>
        </div>
